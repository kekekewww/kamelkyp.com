# Review package — Plan 01 Task 1

Base: 4428d002cd81a6aa2d2ff8d9e88f4b6fc5751e8f
Head: d11cc154c45389c03568d8ba0b42bc1ef6ba852b
...
+      - run: npm ci
+      - run: npm run test:unit -- tests/unit/service-id.test.ts
+      - run: npm run format:check
diff --git a/.gitignore b/.gitignore
new file mode 100644
index 0000000..f9308e2
--- /dev/null
+++ b/.gitignore
@@ -0,0 +1,10 @@
+node_modules/
...
@@ -0,0 +1 @@
+24
diff --git a/app/lib/services/service-id.ts b/app/lib/services/service-id.ts
new file mode 100644
index 0000000..3941c85
--- /dev/null
+++ b/app/lib/services/service-id.ts
@@ -0,0 +1,12 @@
...
+      }
+    },
+    "node_modules/@cloudflare/vite-plugin/node_modules/fsevents": {
+      "version": "2.3.3",
...
+      "version": "0.16.19",
+      "resolved": "https://registry.npmjs.org/@cloudflare/vitest-pool-workers/-/vitest-pool-workers-0.16.19.tgz",
+      "integrity": "sha512-9NQ4xtEBw12xBADSYWOaac+ZxBj0H4UDKHYjD//oBE5P9RD3Cb6JfllB7JqbMOukv/o8d8cEFSqv3NjLRJTCLA==",
+      "dev": true,
+      "license": "MIT",
+      "dependencies": {
...
+      }
+    },
+    "node_modules/@cloudflare/vitest-pool-workers/node_modules/@img/sharp-libvips-linux-ppc64": {
+      "version": "1.2.4",
...
+      }
+    },
+    "node_modules/@cloudflare/vitest-pool-workers/node_modules/@img/sharp-libvips-linux-riscv64": {
+      "version": "1.2.4",
...
+      }
+    },
+    "node_modules/@cloudflare/vitest-pool-workers/node_modules/@img/sharp-linux-ppc64": {
+      "version": "0.34.5",
...
+      }
+    },
+    "node_modules/@cloudflare/vitest-pool-workers/node_modules/@img/sharp-linux-riscv64": {
+      "version": "0.34.5",
...
+      }
+    },
+    "node_modules/@cloudflare/vitest-pool-workers/node_modules/@img/sharp-win32-arm64": {
+      "version": "0.34.5",
...
+      "version": "8.3.0",
+      "resolved": "https://registry.npmjs.org/@react-router/node/-/node-8.3.0.tgz",
...
+  ssr: true,
+} satisfies Config;
diff --git a/tests/unit/service-id.test.ts b/tests/unit/service-id.test.ts
new file mode 100644
index 0000000..8453cc4
--- /dev/null
+++ b/tests/unit/service-id.test.ts
@@ -0,0 +1,18 @@
